...
class Physics {
	...
	static void SimpleVerletMotion(PhysicsObject& object, const float deltaTime);
	...
	static void applyAllForce(PhysicsObject& object, float waterHeight);


	//// Collision detection methods:
	static bool SphereSphereCollisionDetected(const PhysicsObject& PhysicsObject1, const PhysicsObject& PhysicsObject2);
	static bool SpherePlaneCollisionDetected( PhysicsObject& PhysicsObject1,Plane plane);
